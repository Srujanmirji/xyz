...
export const AgentDashboard: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'stats' | 'listings' | 'bookings' | 'inquiries'>('stats');
        ...
        <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-surface border border-outline-variant/30 rounded-xl max-w-2xl w-full p-6 shadow-xl max-h-[90vh] overflow-y-auto space-y-4">
            ...
            <form onSubmit={handleCreateProperty} className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                <label className="block text-xs font-label-md text-on-surface-variant">Price ($)</label>
                <input
                  type="number"
                  required
                  value={newPrice}
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    className="w-full bg-background border border-outline-variant rounded-lg px-2 py-2 text-sm text-on-background focus:outline-none"
                  />
                </div>
                <div className="space-y-1">
              ...
              <div className="md:col-span-2 pt-4 flex gap-4 justify-end border-t border-outline-variant/20">
                <button
                  ...
                  className="bg-surface-container-high hover:bg-surface-container-highest text-on-background px-6 py-2 rounded-lg text-sm font-label-md"
                >
                  Cancel
                </button>
                <button
